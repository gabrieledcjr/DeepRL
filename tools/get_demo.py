...
def get_demo(args):
    ...
    fh = logging.FileHandler('{}/log/{}/{}'.format(demo_memory_folder, hostname, log_file), mode='w')
    ...
    game_state = GameState(env_id=args.gym_env, display=True, human_demo=True, episode_life=episode_life)
