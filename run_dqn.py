...
"""
Baseline:
python3 run_dqn.py pong --cuda_devices=0 --optimizer=Adam --lr=0.0001 --decay=0.0 --momentum=0.0 --epsilon=0.001
python3 run_dqn.py pong --cuda_devices=0 --optimizer=RMS --lr=0.00025 --decay=0.95 --momentum=0.0 --epsilon=0.01
...
def main():
    ...
    parser.add_argument('--train_max_steps', type=int, default=7125000)
    ...
    with tf.Session(config=config) as sess:
        with tf.device('/gpu:'+os.environ["CUDA_VISIBLE_DEVICES"]):
            ...
            experiment = Experiment(
                ...
                args.phi_len, game_state.n_actions, args.batch, args.env,
                args.gamma, args.observe, args.explore, args.final_epsilon,
                args.init_epsilon, args.replay_memory,
